...
bl_info = {
    ...
    "description": "Switch Cameras and create Bound Timeline "
                   "markers naturally."
                   "Update by https://federicoboccaccio.wordpress.com"
				   "Original: https://wiki.blender.org/index.php/Extensions:2.6/Py/Scripts/3D_interaction/Camera_Switcher",
    "author": "Federico Boccaccio (original: Daniel Fairhead)",
    "version": (2, 0),
    "blender": (2, 92, 0),
    "location": "3D View > Tools",
    "category": "View3D",
    "wiki_url": "https://federicoboccaccio.wordpress.com/cam-switcher-update-2-92"
    }
...
class CameraSwitcherPanel(bpy.types.Panel):
    ...
    bl_idname = "PANEL_PT_CAM_SWITCHER_BOX"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_context = "objectmode"
    bl_category = "Camera Tools"

    bpy.types.Scene.camera_switcher_split = bpy.props.BoolProperty(name="Group By Prefix", default=True)
        ...
        for cam in cams:
            if scene.camera_switcher_split:
                ...
                if current_group != new_group:
                    ...
                    row = layout.row()
                    row.label(text=current_group, icon="CAMERA_DATA")
...
class CameraSwitcherCamProps(bpy.types.Panel):
    ...
    bl_idname = "PANEL_PT_CAM_SWITCH_CAMERA_options"
